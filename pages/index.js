        ...
        <Container>
          <header className="max-w-2xl py-20 text-gray-700">
            <h1 className="text-5xl font-extrabold leading-none tracking-tight font-montserrat md:text-6xl">
              We will help you turn your {(<span className={"ml-5 text-"+dTools[activeDT].color}>
            ...
            <h5 className="text-xl mt-4 font-mono">
              ...
              <a href="/" className="ml-3 border-b-2 border-primary hover:border-black hover:text-primary active:border-black active:text-primary focus:border-black focus:text-primary transition-colors ease-in-out duration-300 font-semibold">Start now</a>
            </h5>
          </header>
        </Container>
      </div>

      <div className="flex flex-col md:flex-row relative w-full px-5 md:px-16 my-8 md:my-12">
        ...
        <Container className="my-1 md:-mt-32">
          <div>
            <img src="/img/c0de.png" className="w-full rounded-lg shadow"/>
          </div>
        </Container>
      </div>
